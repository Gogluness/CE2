...
--
-- Client :  localhost
-- Généré le :  Lun 23 Mars 2015 à 16:59
...
(2, '2015-03-23 12:46:27', 'testtest'),
(3, '2015-03-23 12:46:54', 'testtest'),
(4, '2015-03-23 13:45:13', 'testtest'),
(5, '2015-03-23 13:55:47', 'testtest'),
(6, '2015-03-23 15:38:15', 'jeandit');
...
(NULL, 29, 1, 'Amazing', NULL, 'LevelOne/acrobatique/kites_01.jpg', 135, NULL, 9, 'Level One'),
(NULL, 29, 10, 'Neon Patchwork', NULL, 'PremierKites/collection/deltas11/neon_patchwork.jpg', 140, NULL, 5, 'Premier Kites'),
(NULL, 29, 30, 'Easy', NULL, 'LevelOne/acrobatique/kites_03.jpg', 135, NULL, 8, 'Level One'),
...
('454', '455', '', 'c4ca4238a0b923820dcc509a6f7584', '6564654@jkdfh.gikf', '545', '45454', '4545', '2015-03-23 14:59:46'),
('1111', '1111', '111', 'c4ca4238a0b923820dcc509a6f7584', '111@1.1', '11111', '11111', '1111', '2015-03-23 15:01:17'),
('dit', 'jean', 'jeandit', 'e10adc3949ba59abbe56e057f20f88', 'jeandit@hotmail.com', '1010 rue ici', 'A1A 1A1', 'QuÃ©bec', '2015-03-23 15:35:38'),
('1', '11', '1', 'c4ca4238a0b923820dcc509a6f7584', '1@ddfdf.c', '11', '1', '1', '2015-03-23 15:41:27');
...
--
ALTER TABLE `Commande`
MODIFY `NoCommande` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
